...
const Projects = () => {
  ...
  useEffect(() => {
    ...
    updateCardsToShow(); // 🛠️ this was wrongly placed *inside* the function before
  ...
  return (
    <div className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
      <h1 className='text-21 sm:text-4xl font-bold mb-2 text-center'>
      ...
      <div className='overflow-hidden'>
        <div
          ...
          style={{ transform: `translateX(-${(currentIndex * 100) / cardsToShow}%)` }} // 🛠️ fix: use backticks correctly
        >
